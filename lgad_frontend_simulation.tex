...
front-end and noise simulation. %We implement most of the calculations in the
% time domain, while the frequency domain is mostly used
%to cross-check noise and the expected FEE response. Sections~\ref{sec:fee}
% and~\ref{sec:noise_simulation} describe
...
amplitude, and Tab.~\ref{tab:risetime} shows the set of ST and risetimes that we studied. %[Si: what does it mean that
% decay time is ``dominated'' by ST? Dont' understand that sentence]
