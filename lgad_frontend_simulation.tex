...
The results for the pre-irradiated LGAD sensor are summarized in Table.~\ref{tab:shaping_time_prerad},
where the CF results are from the ideal implementation.  Table~\ref{tab:shaping_time_prerad_psCFD} 
...
LGAD signal pulses decrease slightly as the irradiation dosage increases. We consider three 
cases: pre-irradiated, and neutron fluences of $5\times 10^{14}$~n/cm$^2$ and 
$1\times 10^{15}$~n/cm$^2$. We perform the same studies as in the pre-irradiated case discussed in
Sec.~\ref{sec:shaping_time}. The results for the irradiated LGAD sensors are presented in 
